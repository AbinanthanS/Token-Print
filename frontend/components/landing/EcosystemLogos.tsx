...
export const ECOSYSTEM_STACK: LogoItem[] = [
  {
    ...
    name: "Hugging Face",
    svg: (
      <svg height="22" viewBox="0 0 160 28" fill="currentColor" aria-label="Hugging Face">
        ...
        <text x="32" y="19" fontFamily="Inter, system-ui, sans-serif" fontWeight="700" fontSize="15" letterSpacing="-0.02em">Hugging Face</text>
      </svg>
    ),
  },
  {
    ...
    name: "PyTorch",
    svg: (
      <svg height="22" viewBox="0 0 115 28" fill="currentColor" aria-label="PyTorch">
        ...
        <text x="24" y="19" fontFamily="Inter, system-ui, sans-serif" fontWeight="600" fontSize="15" letterSpacing="-0.02em">PyTorch</text>
      </svg>
    ),
  },
  {
    ...
    name: "Transformers",
    svg: (
      <svg height="22" viewBox="0 0 150 28" fill="currentColor" aria-label="Transformers">
        ...
        <text x="28" y="19" fontFamily="Inter, system-ui, sans-serif" fontWeight="600" fontSize="15" letterSpacing="-0.02em">Transformers</text>
      </svg>
    ),
  },
  {
    ...
    name: "GGUF",
    svg: (
      <svg height="22" viewBox="0 0 95 28" fill="currentColor" aria-label="GGUF">
        ...
        <text x="26" y="19" fontFamily="Inter, system-ui, sans-serif" fontWeight="700" fontSize="15" letterSpacing="0.04em">GGUF</text>
      </svg>
    ),
  },
  {
    ...
    name: "llama.cpp",
    svg: (
      <svg height="22" viewBox="0 0 120 28" fill="currentColor" aria-label="llama.cpp">
        <path d="M6 5.5h3.5v9h6v3.5H6v-12.5zM16.5 5.5h3.5v12.5h-3.5v-12.5z" />
        <text x="24" y="19" fontFamily="JetBrains Mono, monospace, system-ui" fontWeight="600" fontSize="14.5" letterSpacing="-0.02em">llama.cpp</text>
      </svg>
    ),
  },
  {
    ...
    name: "FastAPI",
    svg: (
      <svg height="22" viewBox="0 0 110 28" fill="currentColor" aria-label="FastAPI">
        <circle cx="12" cy="14" r="10" />
        <path d="M13 7l-5.5 8h4.5l-1 6 5.5-8h-4.5l1-6z" fill="#000000" />
        <text x="27" y="19" fontFamily="Inter, system-ui, sans-serif" fontWeight="700" fontSize="15" letterSpacing="-0.02em">FastAPI</text>
      </svg>
    ),
  },
  {
    ...
    name: "Next.js",
    svg: (
      <svg height="22" viewBox="0 0 100 28" fill="currentColor" aria-label="Next.js">
        <path d="M12 3a11 11 0 1 0 0 22 11 11 0 0 0 0-22zm4.2 15.3l-5-6.8v6.8H9.7V9.7h1.7l5 6.8V9.7h1.5v8.6h-1.7z" />
        <text x="27" y="19" fontFamily="Inter, system-ui, sans-serif" fontWeight="700" fontSize="15" letterSpacing="-0.03em">Next.js</text>
      </svg>
    ),
  },
  {
    ...
    name: "React",
    svg: (
      <svg height="22" viewBox="0 0 100 28" fill="currentColor" aria-label="React">
        ...
        <text x="27" y="19" fontFamily="Inter, system-ui, sans-serif" fontWeight="700" fontSize="15" letterSpacing="-0.02em">React</text>
      </svg>
    ),
  },
];
